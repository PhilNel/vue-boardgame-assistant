<template>
  <div class="footnote-container">
    <div class="footnote-text" @click="handleFootnoteClick" v-html="processedHtml"></div>

    <ReferencesSection :references="props.references" />

    <FootnoteModal :show="showModal" :reference="selectedReference" @close="closeModal" />
  </div>
</template>
