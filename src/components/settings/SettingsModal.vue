<template>
  <BaseModal
    :show="settingsStore.isModalOpen"
    title="Settings"
    submit-text="Save"
    :submit-disabled="!apiKeyInput.trim()"
    @close="handleClose"
    @submit="handleSave"
  >
    <template #body>
      <div class="setting-section">
        ...
        <p class="setting-description">Enter your API key to access the boardgame assistant.</p>
        <div class="input-group">
          ...
          />
          <button class="toggle-visibility-button" title="Toggle visibility" @click="toggleShowKey">
