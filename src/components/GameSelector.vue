<template>
  <div class="flex items-center space-x-3">
    <label for="game-select" class="text-chat-text font-medium">
      Game:
    </label>
    <div class="relative">
      <select
        ...
        class="bg-chat-input border border-chat-border rounded-lg px-3 pr-8 py-2 text-chat-text focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent appearance-none"
      >
        <option
