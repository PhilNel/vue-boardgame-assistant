...
const S3_ARTEFACT_BUCKET =
  process.env.S3_ARTEFACT_BUCKET || "boardgame-assistant-artefacts-dev-eu-west-1";
const S3_PREFIX =
  process.env.S3_PREFIX !== undefined ? process.env.S3_PREFIX : "vue-boardgame-assistant";
...
if (!existsSync(DIST_DIR)) {
  console.error("❌ Error: dist/ directory not found. Run 'bun run build:s3' first");
  process.exit(1);
}
